    ...
    <v-layout>
        <v-flex>
          <v-stepper v-model="e1">
            <v-stepper-header>
              <v-stepper-step :complete="e1 > 1" step="1">Bylo nebylo</v-stepper-step>

              <v-divider></v-divider>

              <v-stepper-step :complete="e1 > 2" step="2">Da</v-stepper-step>

              <v-divider></v-divider>

              <v-stepper-step step="3">Foto</v-stepper-step>
            </v-stepper-header>
